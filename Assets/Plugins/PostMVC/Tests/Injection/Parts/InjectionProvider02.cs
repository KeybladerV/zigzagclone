...
namespace Build1.PostMVC.Core.Tests.Injection.Parts
{
    public sealed class InjectionProvider02 : InjectionProvider<IInjectionProviderItem>
    {
        ...
        private readonly Stack<IInjectionProviderItem> _availableInstances = new Stack<IInjectionProviderItem>();
        private readonly List<IInjectionProviderItem>  _usedInstances = new List<IInjectionProviderItem>();
