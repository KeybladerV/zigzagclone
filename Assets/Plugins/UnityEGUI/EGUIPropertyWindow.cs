...
namespace Build1.UnityEGUI
{
    ...
    {
        public static Vector2Int PropertyWindowSizeDefault { get; set; } = new Vector2Int(600, 400);

        private static readonly List<PropertyWindowImpl> _windowsInstances = new List<PropertyWindowImpl>();
